<!-- Modal -->
<div class="modal fade " id="exampleModalCenterU2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterUTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      {{ csrf_field() }}
        ...
        @foreach($nhanburgue as $as)       
        <!-- <h4>Adicionais</h4>
        <div class="form-group">
          <div class="col-md-12 mb-3">
              <label for="disabledSelect">Salada {{$as->salada}}</label>
                <input type="checkbox" value="{{$as->salada}}" class="form-control acres" id="salada" name="salada" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12 mb-3">
              <label for="disabledSelect">Carnes {{$as->carnes}}</label>
                <input type="checkbox" class="form-control acres" id="" name="" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12 mb-3">
              <label for="disabledSelect">Presunto {{$as->presunto}}</label>
                <input type="checkbox" class="form-control acres" id="" name="" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12 mb-3">
              <label for="disabledSelect">Ovos {{$as->ovos}}</label>
                <input type="checkbox" class="form-control acres" id="" name="" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12 mb-3">
              <label for="disabledSelect">Cheddan {{$as->cheddan}}</label>
                <input type="checkbox" class="form-control acres" id="" name="" />
          </div>
        </div>
        <div class="form-group">
