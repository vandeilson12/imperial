                    ...
                    <table class="table table-data2">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Carne Moida</th>
                                <th scope="col">Salada</th>
                                <th scope="col">Calabreza</th>
                                <th scope="col">Milho</th>
                                <th scope="col">Ervilha</th>
                                <th scope="col">Salsicha</th>
                        ...
                        <tbody>
                            <tr class="tr-shadow">
                                ...
                                @php
                                    $bb=$cachor->find($cachor->id);
                                @endphp


                                    <td>R$ {{$bb['carne_moida']}}</td>
                                    <td>R$ {{$bb['salada']}}</td>
                                    <td>R$ {{$bb['calabreza']}}</td>
                                    <td>R$ {{$bb['milho']}}</td>
                                    <td>R$ {{$bb['ervilha']}}</td>
                                    <td>R$ {{$bb['salsicha']}}</td>
                                    <td>R$ {{$bb['queijo']}}</td>
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        ...
                                        <a href="{{url("/cachorro/$cachor->id/edit")}}">
